        ...
        <>
            <div className="about-main">
                ...
                <div className="text Montserrat">
                    <p className="oswald">
                        Проверенная классика в авторском прочтении 0 только
                        фермерские продукты и мастерство наших шефов
                    </p>
                </div>
            </div>
            ...
            <div className="about_half">
                ...
                <img
                    ...
                    src="/assets/Restoraunt_Photos/10724.jpg"
                    alt=""
                />
            </div>
            ...
            <div className="about_half">
                <img
                    className="second_half"
                    src="/assets/Restoraunt_Photos/927.jpg"
                    alt=""
                />
                <div className="first_half">
                    <div className="first_half_desc_text second">
                        <h1 className="montserrat">
                            Ваше доверие - наша главная ценность, а безупречный
                            сервис - наш золотой стандарт
                        </h1>
                        {/* <p className='montserrat'>
                            sdsd
                        </p> */}
            ...
            <div className="zagolovok-slider">
                <div className="zagolovok montserrat">
                    Просмотрите наши новинки
                </div>
                <Slider
