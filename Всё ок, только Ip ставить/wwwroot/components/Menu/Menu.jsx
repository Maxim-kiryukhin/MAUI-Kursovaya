...
function Menu(props) {
    ...
    useEffect(() => {
        if (menu_page === "Холодные закуски") {
            setIsLoading(true);
            fetch(`${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/cold`)
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
                    setIsLoading(false);
            ...
            setIsLoading(true);
            fetch(`${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/hot`)
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
                    setIsLoading(false);
            ...
            setIsLoading(true);
            fetch(`${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/main`)
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
                    setIsLoading(false);
            ...
            setIsLoading(true);
            fetch(`${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/soup`)
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
                    setIsLoading(false);
            ...
            setIsLoading(true);
            fetch(
                `${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/sweet`,
            )
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
            ...
            setIsLoading(true);
            fetch(
                `${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/drinks`,
            )
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
            ...
            setIsLoading(true);
            fetch(`${import.meta.env.VITE_API_URL}/api/getgoodsbycategory/bar`)
                .then((res) => res.json())
                .then((data) => {
                    setGoods(data.data);
                    setIsLoading(false);
            ...
            <div>
                ...
                <div className="menu_middle">
                    <div className="menu_select">
                        <div
                            className="select_but montserrat"
                            onClick={() => ChangeMenu_page("Холодные закуски")}
                        >
                            Холодные закуски
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Горячие закуски")}
                        >
                            Горячие закуски
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Основные блюда")}
                        >
                            Основные блюда
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Супы")}
                        >
                            Супы
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Десерты")}
                        >
                            Десерты
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Напитки")}
                        >
                            Напитки
                        </div>
                        <div
                            className="select_but"
                            onClick={() => ChangeMenu_page("Барная карта")}
                        >
                            Барная карта
                        </div>
                    </div>
